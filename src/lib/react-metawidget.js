...
reactmw.widgetprocessor = metawidget.widgetprocessor || {};
...
reactmw.react.widgetprocessor.ValueAttributeProcessor.prototype.processWidget = function (widget, elementName, attributes) {
    ...
    getDefaultProps: function () {
        return {
            ...
            widgetBuilder: new metawidget.widgetbuilder.CompositeWidgetBuilder([
                new reactmw.react.widgetbuilder.ReactWidgetBuilder({doLabels: false})
            ]),
            widgetProcessors: [
            ...
            layout: new reactmw.react.layout.ReactRenderDecorator(
                new reactmw.layout.HeadingTagLayoutDecorator(
                    new reactmw.layout.TableLayout({numberOfColumns: 2})
                )
            )
        }
    },
